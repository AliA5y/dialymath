...
class StudentForm extends StatefulWidget {
  const StudentForm({super.key,required this.day,this.groupId,});
  final int day;
  final int ?groupId;
                        ...
                        CoustmTextfield(
                         ...
                         Row(
                          ...
                          mainAxisAlignment: MainAxisAlignment.center,
                           children: [
                             CoustmBt(bttext: 'Add Student',
                             isload: State is AddgroupLoading ?true:false,
                             ontab:(){if (formKey.currentState!.validate()){
                              formKey.currentState!.save();
                              var studentmodel=StudentModel(studentname:name! ,parentrhone:phone!,idgroup: widget.groupId!);
                              BlocProvider.of<GroupCubitCubit>(context).addstudent(studentmodel);
                             }else {
